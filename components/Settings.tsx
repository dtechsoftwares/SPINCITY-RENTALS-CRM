...
const Settings: React.FC<SettingsProps> = ({ onUpdateLogo, currentLogo, smsSettings, onUpdateSmsSettings, adminKey, onUpdateAdminKey }) => {
                ...
                <section>
                    ...
                    <div className="flex items-center space-x-6 bg-gray-50 p-6 rounded-lg border border-gray-200">
                         ...
                         <div className="flex-grow">
                             ...
                             <p className="text-sm text-gray-500 mb-3">Upload a new logo. Recommended size: 128x128px.</p>
                             <input 
                                 type="file" 
                                 accept="image/*" 
